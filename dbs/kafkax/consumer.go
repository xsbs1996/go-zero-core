...
var (
	ErrNilReader         = errors.New("kafkax: reader is nil")          // ErrNilReader 表示 Kafka reader 为空。
	ErrNilConsumeHandler = errors.New("kafkax: consume handler is nil") // ErrNilConsumeHandler 表示消费处理函数为空。
	ErrNilBatchHandler   = errors.New("kafkax: batch handler is nil")   // ErrNilBatchHandler 表示批量消费处理函数为空。
	ErrInvalidBatchSize  = errors.New("kafkax: invalid batch size")     // ErrInvalidBatchSize 表示批量大小非法。
	ErrInvalidBatchTime  = errors.New("kafkax: invalid batch timeout")  // ErrInvalidBatchTime 表示批量等待时间非法。
)
