...
var (
	ErrNilWriter         = errors.New("kafkax: writer is nil")       // ErrNilWriter 表示 Kafka writer 为空。
	ErrInvalidWriteBatch = errors.New("kafkax: empty message batch") // ErrInvalidWriteBatch 表示批量消息为空。
)
