...
var (
	ErrMissingName               = errors.New("rabbitmqx: missing name")                 // ErrMissingName 表示注册名称为空。
	ErrNilConnection             = errors.New("rabbitmqx: connection is nil")            // ErrNilConnection 表示 RabbitMQ 连接为空。
	ErrNilChannel                = errors.New("rabbitmqx: channel is nil")               // ErrNilChannel 表示 RabbitMQ channel 为空。
	ErrNilHandler                = errors.New("rabbitmqx: handler is nil")               // ErrNilHandler 表示消费处理函数为空。
	ErrInvalidPublishBatch       = errors.New("rabbitmqx: empty publish batch")          // ErrInvalidPublishBatch 表示批量发布消息为空。
	ErrProducerAlreadyRegistered = errors.New("rabbitmqx: producer already registered")  // ErrProducerAlreadyRegistered 表示生产者已经注册。
	ErrConsumerAlreadyRegistered = errors.New("rabbitmqx: consumer already registered")  // ErrConsumerAlreadyRegistered 表示消费者已经注册。
	ErrProducerNotRegistered     = errors.New("rabbitmqx: producer not registered")      // ErrProducerNotRegistered 表示生产者未注册。
	ErrConsumerNotRegistered     = errors.New("rabbitmqx: consumer not registered")      // ErrConsumerNotRegistered 表示消费者未注册。
	ErrMissingQueue              = errors.New("rabbitmqx: missing rabbitmq queue")       // ErrMissingQueue 表示 RabbitMQ queue 为空。
	ErrMissingExchange           = errors.New("rabbitmqx: missing rabbitmq exchange")    // ErrMissingExchange 表示 RabbitMQ exchange 为空。
	ErrMissingRoutingKey         = errors.New("rabbitmqx: missing rabbitmq routing key") // ErrMissingRoutingKey 表示 RabbitMQ routing key 为空。
	ErrNilClient                 = errors.New("rabbitmqx: client is nil")                // ErrNilClient 表示 RabbitMQ 客户端为空。
)
