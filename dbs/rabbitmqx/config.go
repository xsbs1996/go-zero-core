...
var (
	ErrMissingHost     = errors.New("rabbitmqx: missing rabbitmq host")     // ErrMissingHost 表示 RabbitMQ 地址为空。
	ErrMissingUsername = errors.New("rabbitmqx: missing rabbitmq username") // ErrMissingUsername 表示 RabbitMQ 用户名为空。
)
