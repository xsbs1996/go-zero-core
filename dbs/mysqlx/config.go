...
var (
	ErrMissingHost   = errors.New("mysqlx: missing mysql host")     // ErrMissingHost 表示 MySQL 地址为空。
	ErrMissingUser   = errors.New("mysqlx: missing mysql user")     // ErrMissingUser 表示 MySQL 用户名为空。
	ErrMissingDBName = errors.New("mysqlx: missing mysql database") // ErrMissingDBName 表示 MySQL 数据库名为空。
)
