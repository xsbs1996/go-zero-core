...
var (
	ErrMissingHost   = errors.New("postgresx: missing postgres host")     // ErrMissingHost 表示 PostgreSQL 地址为空。
	ErrMissingUser   = errors.New("postgresx: missing postgres user")     // ErrMissingUser 表示 PostgreSQL 用户名为空。
	ErrMissingDBName = errors.New("postgresx: missing postgres database") // ErrMissingDBName 表示 PostgreSQL 数据库名为空。
)
