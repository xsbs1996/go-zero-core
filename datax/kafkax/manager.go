...
var (
	ErrProducerAlreadyRegistered = errors.New("kafkax: producer already registered") // ErrProducerAlreadyRegistered 表示生产者路由已经注册。
	ErrConsumerAlreadyRegistered = errors.New("kafkax: consumer already registered") // ErrConsumerAlreadyRegistered 表示消费者路由已经注册。
	ErrProducerNotRegistered     = errors.New("kafkax: producer not registered")     // ErrProducerNotRegistered 表示生产者路由未注册。
	ErrConsumerNotRegistered     = errors.New("kafkax: consumer not registered")     // ErrConsumerNotRegistered 表示消费者路由未注册。
	ErrNilManager                = errors.New("kafkax: manager is nil")              // ErrNilManager 表示管理器为空。
)
