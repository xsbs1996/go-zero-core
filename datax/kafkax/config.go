...
var (
	ErrMissingBrokers = errors.New("kafkax: missing kafka brokers")  // ErrMissingBrokers 表示 Kafka broker 地址为空。
	ErrMissingTopic   = errors.New("kafkax: missing kafka topic")    // ErrMissingTopic 表示 Kafka topic 为空。
	ErrMissingGroupID = errors.New("kafkax: missing kafka group id") // ErrMissingGroupID 表示 Kafka 消费组为空。
)
