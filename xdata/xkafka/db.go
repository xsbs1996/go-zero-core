...
var (
	...
	ErrNilProducer                = errors.New("xkafka: producer is nil") // ErrNilProducer 表示 Kafka 生产者为空。
	ErrNilConsumer                = errors.New("xkafka: consumer is nil") // ErrNilConsumer 表示 Kafka 消费者为空。
)
