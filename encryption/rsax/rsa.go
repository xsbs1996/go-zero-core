...
var (
	ErrInvalidPrivateKey = errors.New("rsax: invalid private key") // ErrInvalidPrivateKey 表示私钥不合法。
	ErrInvalidPublicKey  = errors.New("rsax: invalid public key")  // ErrInvalidPublicKey 表示公钥不合法。
)
